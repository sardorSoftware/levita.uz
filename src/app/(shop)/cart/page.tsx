...
export default function CartPage() {
    ...
    return (
        ...
        {items.map((item) => (
            ...
            <h3 className="text-sm font-semibold text-dark line-clamp-2 pr-20">{item.title}</h3>
            
            {/* O'ng ustki qismdagi tugmalar (Yurakcha va O'chirish) */}
            ...
            className="p-2.5 text-gray-400 hover:text-red-500 bg-gray-50 hover:bg-red-50 rounded-full transition-colors cursor-pointer shadow-md"
